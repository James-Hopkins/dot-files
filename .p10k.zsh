# Generated by Powerlevel10k configuration wizard on 2021-12-08 at 23:06 GMT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 19497.
# Wizard options: powerline, rainbow, ascii, 24h time, 2 lines, disconnected, compact,
...
() {
  ...
  # Removed to see git in home folder
